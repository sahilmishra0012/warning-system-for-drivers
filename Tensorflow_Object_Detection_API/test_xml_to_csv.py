...
train_files=pd.read_csv('/home/samthekiller/Downloads/Smart India Hackathon/INTEL/data/IDD_Detection/test.txt',sep='/',header=None)
...
xml_df.to_csv(('/home/samthekiller/Downloads/Smart India Hackathon/INTEL/data/IDD_Detection/test_labels.csv'),index=None)
